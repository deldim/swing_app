...
import data.factory.model.Model_Menu;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        listMenu1 = new data.factory.swing.ListMenu<>();

        panelMoving.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/data/factory/icon/bnp.png"))); // NOI18N
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, new Color(50, 156, 148), 0, getHeight(), new Color(0, 187, 160));
        g2.setPaint(g);
    ...
    private data.factory.swing.ListMenu<String> listMenu1;
